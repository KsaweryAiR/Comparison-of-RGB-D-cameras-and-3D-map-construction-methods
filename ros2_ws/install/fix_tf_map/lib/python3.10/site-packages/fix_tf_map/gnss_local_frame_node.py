...
class GNSSLocalFrameNode(Node):
    def __init__(self):
        ...
        # Tu będziemy przechowywać ostatni czas z PointCloud2
        self.latest_pc_stamp = None

    def pc_callback(self, msg: PointCloud2):
        # Zapamiętaj czas z nagłówka wiadomości pointcloud
    ...
    def gnss_callback(self, msg: PoseWithCovarianceStamped):
        ...
        t = TransformStamped()
        # Używamy czasu z PointCloud2 jako timestamp transformacji
